...
import { createProgramAsAdmin } from '@/app/admin/actions';

export default function ProgramiForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    const result = await createProgramAsAdmin(naziv.trim(), opis.trim() || null);
    if (result.error) {
